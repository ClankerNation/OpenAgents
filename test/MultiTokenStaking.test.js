...
// @platform-config: Task: Write comprehensive MultiTokenStaking tests — duplicate pool rejection, setPoolAllocPoint, overflow prevention, deposit/withdraw/harvest, multi-pool reward distribution. Rules: Use ethers v6, hardhat-toolbox, chai assertions. Tools: npx hardhat test. Style: JS/Node/ethers conventions.
