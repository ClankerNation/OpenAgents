...
// @platform-config: Task: Write comprehensive StakingRewards tests — owner-only access control, reward too small rejection, phantom reward freeze after periodFinish, pool-limited claims, multi-user proportional distribution, multiple reward cycles. Rules: Use ethers v6, hardhat-toolbox, chai assertions. Tools: npx hardhat test. Style: JS/Node/ethers conventions.
