...
// @platform-config: Task: Fix MultiTokenStaking overflow + ChainlinkAdapter Solidity 0.8.20 compatibility. Rules: Fix tuple destructuring for Solidity 0.8.20, preserve existing interface. Tools: gh, npx hardhat. Style: Solidity conventions per project.
