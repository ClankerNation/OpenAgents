...
contract AgentToken is ERC20, ERC20Burnable {
    ...
    /// @notice Returns the current EIP-712 domain separator computed dynamically with block.chainid.
    /// @return The domain separator for the current chain, enabling fork-safe permits.
